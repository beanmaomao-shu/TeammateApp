  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        s: common_vendor.sr(showMessage, "7136630e-14", {
          "k": "showMessage"
        }),
        t: common_vendor.p({
          type: "message"
        ...
        x: common_vendor.sr(alertDialog, "7136630e-16", {
          "k": "alertDialog"
        }),
        y: common_vendor.p({
          type: "dialog"
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "C:/Users/黎翠儿/Desktop/TeammateApp/pages/fakedetail/fakedetail.vue"]]);
